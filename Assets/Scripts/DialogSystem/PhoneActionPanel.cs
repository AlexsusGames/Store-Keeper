...
public class PhoneActionPanel : MonoBehaviour
{
    ...
    {
        string translatedFirst = Core.Localization.Translate(firstAction);
        string translatedSecond = Core.Localization.Translate(secondAction);

        firstActionButton.GetComponentInChildren<TMP_Text>().text = translatedFirst;
        secondActionButton.GetComponentInChildren<TMP_Text>().text= translatedSecond;
    }
